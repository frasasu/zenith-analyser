...
'''
    ...
    expected_types = [
        'target', 'identifier', 'colon', 'newline',
        'key', 'colon', 'string', 'newline',
        'law', 'identifier', 'colon', 'newline',
        'start_date', 'colon', 'date', 'at', 'time', 'newline',
        'period', 'colon', 'dotted_number', 'newline',
        'Event', 'colon', 'newline',
        'identifier', 'colon', 'string', 'newline',
        'GROUP', 'colon', 'lparen', 'identifier', 'number',
        'carrot', 'number', 'rparen', 'newline',
        'end_law', 'newline',
        'end_target', 'EOF'
    ]
...
"""
    ...
    identifier_tokens = [t for t in tokens if t['type'] == 'identifier' and t['line'] == 1]
